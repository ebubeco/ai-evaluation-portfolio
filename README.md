...
This work focuses on identifying where model outputs fail, why they fail, and what needs to change for them to improve.

The emphasis is on reasoning, not just correctness. A response can be fluent, structured, and still wrong in ways that matter. These case studies surface those failures and document them precisely.
