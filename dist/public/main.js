...
(function(){
  ...
  function showThinking(){
    ...
    resContent.innerHTML = '<div class="kb-thinking"><span></span><span></span><span></span></div>';
  }
  ...
  async function askKB(question){
    ...
    try {
      ...
      const data = await res.json();
      resContent.textContent = data.reply || 'No response generated. Please try again.';
    } catch(err) {
      resContent.innerHTML = 'The assistant is currently offline. Please <a href="mailto:charlesgigz7@gmail.com" style="color:var(--teal)">reach out directly</a> — Ebube responds within 24 hours.';
    }
